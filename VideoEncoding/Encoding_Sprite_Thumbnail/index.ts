...
const namePrefix: string = "encodeSpriteThumb";
const transformName = "SpriteThumbnail";
...
export async function main() {
        ...
        preset: factory.createStandardEncoderPreset({
            codecs: [
                ...
                factory.createH264Video({
                    ...
                    complexity: KnownH264Complexity.Speed, // Set to speed mode, as we really only care about the sprite in this sample
                    layers: [
    ...
    let transform: Transform = {
        name: transformName,
        description: "Generates a sprite thumbnail (VTT) and a speed encoding of  720P layer of H264 with AAC audio",
