...
const namePrefix: string = "encodeFadeInFadeOut";
const transformName = "H264EncodingFadeInFadeOut";
...
export async function main() {
    ...
    let transform: Transform = {
        name: transformName,
        description: "A simple custom H264 encoding transform that fades in and out from a custom color on the video source",
    ...
    let jobInputs = [   // Create a list of JobInputs 
        jobVideoInputAsset,
       ]
