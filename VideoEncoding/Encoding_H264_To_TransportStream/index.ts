...
const namePrefix: string = "encodeH264_to_TS";
const transformName = "H264EncodingTransportStream";
...
export async function main() {
    ...
    let transformOutput: TransformOutput[] = [{
        preset: factory.createStandardEncoderPreset({
            ...
            formats: [
                // Mux the H.264 video and AAC audio into Transport Stream container, using basename, label, bitrate and extension macros
                // Note that since you have multiple H264Layers defined above, you have to use a macro that produces unique names per H264Layer
                // Either {Label} or {Bitrate} should suffice
                factory.createTSFormat({
