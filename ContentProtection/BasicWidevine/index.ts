...
// Create a new Content Key Policy using Widevine DRM only
...
async function getToken(issuer: string, audience: string, keyIdentifier: string, tokenSigningKey: Uint8Array): Promise<any> {
  ...
  let claims = {
    // "urn:microsoft:azure:mediaservices:contentkeyidentifier": keyIdentifier, //optional for advanced scenarios
