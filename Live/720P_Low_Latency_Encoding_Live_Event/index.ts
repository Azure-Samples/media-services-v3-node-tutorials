    ...
    try {
        ...
        let liveEventCreate: LiveEvent = {
            ...
            encoding: {
                ...
                encodingType: KnownLiveEventEncodingType.Standard,
            ...
            // To enable Apple's Low Latency HLS (LL-HLS) streaming, you must use the "LowLatencyV2" stream option
            streamOptions: [
        ...
        if (asset.name) {
            liveOutputCreate = {
                ...
                rewindWindowLength: "PT5M", // sets the time-shift (DVR) window to 5 minutes. Uses ISO 8601 format string.
                hls: {
